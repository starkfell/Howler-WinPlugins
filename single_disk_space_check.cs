...
Application Name: single_disk_space_check.exe
...
Changes:          12.08.2012 - [R. Irujo]
                  ...
                  12.09.2012 - [R. Irujo]
                  - Changed Application Name to align up with the NRPE and NSC.ini format.


Syntax:           single_disk_space_check.exe <Drive_Letter> <Warning_Percent> <Critical_Percent>
 
Example:          single_disk_space_check.exe "C" "10.00" "5.00"

NSC.ini Format:   command[win_single_disk_space_check]=X:\Path\To\Plugins\single_disk_space_check.exe $ARG1$ $ARG2$ $ARG3$

NRPE Syntax:      ./check_nrpe -H <hostname> -c win_single_disk_space_check -a <Drive_Letter> <Warning_Percent> <Critical_Percent>
